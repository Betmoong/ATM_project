...
public class Withdraw extends Bank {
    ...
    public void withdraw()
    {
        ...
        System.out.print("출금하실 계좌의 은행을 선택해주세요 : ");
        button = scanner.next();
        ...
        System.out.println("*** 출금 가능 잔액 : [" + balance + "]원 ***");
        ...
        System.out.println("===========================");
        System.out.println("위 정보가 맞으면 1번(출금), 틀리면 2번(취소)을 입력해주세요.");
        System.out.print("1번[출금], 2번[취소] : ");
        okay = scanner.next();
        ...
        if(okay.equals("1"))
        {
            ...
            try {
                ...
                //거래명세표 출력
                statementOfAccount.soa(my_bank_name, "예금출금", money, balance ,0, acc_number);
